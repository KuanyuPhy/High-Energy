...
*/
	...
	combination(eta, ptype_eta_cand, tpi_plus, tpi_minus, pi_0, 0.0073, 0.0127);
	...
	int run = 0;
	float nowvchisq = 100;
	float nowvchisq2 = 100;
	double lastchic0mass = 1;
	double lastchoose = 100;
	float vchisq;
	float vchisq2;
	...
	for (std::vector<Particle>::iterator i = B_cand1.begin(); i != B_cand1.end(); i++)
	{
		...
		double chic0mass = (*i).child(0).p().mag();
		double choose = abs(chic0mass - MCHIC0_PDG) + abs(etamass - META_PDG);
		run += 1;
		kvertexfitter kvf;
		...
		kvertexfitter kvf2;
		addTrack2fit(kvf2, (*i).child(1).child(0));
		addTrack2fit(kvf2, (*i).child(1).child(1));
		unsigned err2 = kvf2.fit();
		if (err2 == 0)
		{
			vchisq2 = kvf2.chisq();
		}
		...
		if ((((*i).child(1).child(0).px() == (*i).child(0).child(0).px()) && ((*i).child(1).child(0).py() == (*i).child(0).child(0).py()) &&
			 ((*i).child(1).child(0).pz() == (*i).child(0).child(0).pz())) ||
			((*i).child(1).child(0).px() == (*i).child(0).child(1).px()) && ((*i).child(1).child(0).py() == (*i).child(0).child(1).py()) && ((*i).child(1).child(0).pz() == (*i).child(0).child(1).pz()))
		{
			continue;
		}
		else
		{
			if ((((*i).child(1).child(1).px() == (*i).child(0).child(2).px()) && ((*i).child(1).child(1).py() == (*i).child(0).child(2).py()) && ((*i).child(1).child(1).pz() == (*i).child(0).child(2).pz())) ||
				((*i).child(1).child(1).px() == (*i).child(0).child(3).px()) && ((*i).child(1).child(1).py() == (*i).child(0).child(3).py()) && ((*i).child(1).child(1).pz() == (*i).child(0).child(3).pz()))
			{
				continue;
			}
			else
			{
				...
				{
					if (vchisq >= 0 && vchisq < 100 && vchisq2 >= 0 && vchisq2 < 100 && mass >= 5.2 && mass <= 5.29 && de > -.2 && de < .2 && etamass > 0.538674 && etamass < 0.556126 && pi10_p < 0.4 && pi11_p < 0.4 && chic0mass > 3.35364 && chic0mass < 3.47236) //delta e：de
					{
						lastchoose = choose;
						lastchic0mass = chic0mass;
						lastetamass = etamass;
						btag = run;
					}
					else
	...
	for (std::vector<Particle>::iterator i = B_cand1.begin(); i != B_cand1.end(); i++)
	{
		...
		if (btag == runi)
		{
			...
			////fill eta pi+
			b_tpl->column("pippx1", (*i).child(1).child(0).px()); //eta 的pi+
			b_tpl->column("pippy1", (*i).child(1).child(0).py());
			b_tpl->column("pippz1", (*i).child(1).child(0).pz());
			b_tpl->column("pippe1", (*i).child(1).child(0).e());
			b_tpl->column("pipmass1", (*i).child(0).child(1).p().mag());

			//分辨etapi-
			b_tpl->column("pinpx1", (*i).child(1).child(1).px()); //eta 的pi+
			b_tpl->column("pinpy1", (*i).child(1).child(1).py());
			b_tpl->column("pinpz1", (*i).child(1).child(1).pz());
			b_tpl->column("pinpe1", (*i).child(1).child(1).e());
			b_tpl->column("pinmass1", (*i).child(1).child(1).p().mag());
			//eta pi0
			...
			b_tpl->column("pi0mass", (*i).child(1).child(2).p().mag());
			//pi0gamma
			...
			exk_eta.LinkParticle(&KF_ch5);
			exk_eta.LinkParticle(&KF_ch6);
