...
// Module class
class ana_plambdag_1221 : public Module 
{
public:
  ana_plambdag_1221(void){};
  ~ana_plambdag_1221(void){};
  void init(int*);
  void term(void);
...
extern "C" Module_descr *mdcl_ana_plambdag_1221()
{
  ana_plambdag_1221 *module = new ana_plambdag_1221;
  Module_descr *dscr = new Module_descr ( "ana_plambdag_1221", module );
...
void 
ana_plambdag_1221::hist_def(void)
{ 
...
//branch name length--> 8 characters(upper limit)
  b_tpl = BASF_Histogram->ntuple("Btolambdag","mbc modmbc de ebeam EVTID RUNID EXPID eventid farmid \
  pxb pyb pzb eb \
  ...
  pxGam1  pyGam1  pzGam1  epGam1 piveto pi0prob1 \
  m_pl chisqexk \
  hindex hi100 hi101 hi2 hi0 mo100 mo101 mo2 mo0 gmo100 gmo101 gmo0 gmo2 ggmo100 ggmo101  \
  charged mgridp mgridn nbnd nbpd bpd1 bpd2 bpd3 bpd4 bnd1 bnd2 bnd3 bnd4 \
  bndnumber bvertexx bvertexy bvertexz overtexx overtexy overtexz \
...
void ana_plambdag_1221::init(int*)
{
  evtcount=0;
...
void ana_plambdag_1221::term (void)
{
/*
...
void ana_plambdag_1221::begin_run(BelleEvent *evptr, int *status)
{
...
void 
ana_plambdag_1221::event(BelleEvent *evptr, int *status)
{ 
  ...
  combination(B_cand1,ptype_Bplus,p_plus,Lambar_list,gamma);
  combination(B_cand1,ptype_Bminus,p_minus,Lam_list,gamma);
  
  
  //for B candicate 21
  //For B->p Lambda gamma decay
  //B-->p1 Lambda Gam1
  //       Lam --> p2 pi
...
//------------------- information of p+ (p1) (*i).child(0) -----------------------
      ...
      b_tpl->column("massLam", (*i).child(1).p().mag());
      b_tpl->column("pxLam", (*i).child(1).px());
      b_tpl->column("pyLam", (*i).child(1).py());
      b_tpl->column("pzLam", (*i).child(1).pz());
      b_tpl->column("epLam", (*i).child(1).e());

      //boosted to CMS frame
      HepLorentzVector Lam_p((*i).child(1).p() );
      Lam_p.boost( boost_vector.boostVector() );
      
      
      float fd = sqrt(((*i).child(1).mdstVee2().v(0)-IP.x())*((*i).child(1).mdstVee2().v(0)-IP.x())+
		      ((*i).child(1).mdstVee2().v(1)-IP.y())*((*i).child(1).mdstVee2().v(1)-IP.y())); 
      b_tpl->column("Lam_dr",fd);           
      fd = abs((*i).child(1).mdstVee2().v(2)-IP.z());
      b_tpl->column("Lam_dz",fd);
      b_tpl->column("Lam_zdst", (*i).child(1).mdstVee2().z_dist());
      b_tpl->column("Lam_vx", (*i).child(1).mdstVee2().v(0));
      b_tpl->column("Lam_vy", (*i).child(1).mdstVee2().v(1));
      b_tpl->column("Lam_vz", (*i).child(1).mdstVee2().v(2));  
      b_tpl->column("Lam_vr", sqrt((*i).child(1).mdstVee2().v(0)*(*i).child(1).mdstVee2().v(0) +(*i).child(1).mdstVee2().v(1)*(*i).child(1).mdstVee2().v(1)) ); 
      b_tpl->column("chisqL", (*i).child(1).mdstVee2().chisq());                                                                         
      FindLambda find_ilam;
      find_ilam.candidates((*i).child(1).mdstVee2(),IP);
      b_tpl->column("goodLam",find_ilam.goodLambda());      
      
      //------------------- information of pi+ from Lambda-bar or p+ from Lambda (*i).child(1).child(0).child(0) -------
      b_tpl->column("mass100", (*i).child(1).child(0).p().mag());
      b_tpl->column("px100", (*i).child(1).child(0).px());
      b_tpl->column("py100", (*i).child(1).child(0).py());
      b_tpl->column("pz100", (*i).child(1).child(0).pz());
      b_tpl->column("e100", (*i).child(1).child(0).e());
      ...
      b_tpl->column("mass101", (*i).child(1).child(1).p().mag());
      b_tpl->column("px101", (*i).child(1).child(1).px());
      b_tpl->column("py101", (*i).child(1).child(1).py());
      b_tpl->column("pz101", (*i).child(1).child(1).pz());
      b_tpl->column("e101", (*i).child(1).child(1).e());
      
      const Mdst_charged* chpi = &(*i).child(1).child(1).mdstCharged();
      ...
      double cos_polar_pi;
      Vector3 chpi_momentum((*i).child(1).child(1).px(), (*i).child(1).child(1).py(), (*i).child(1).child(1).pz());
      ...
      b_tpl->column("m_pl",p_dib.mag()); // Save the magnitude of the 4 monentum -->mass 
	...
	if(tmp.e()>0.03){
      ...
      Mdst_charged Mdst_100 =(*i).child(1).child(0).mdstCharged(); //p+ from Lambda-bar or pi+ from Lambda
      Mdst_charged Mdst_101 =(*i).child(1).child(1).mdstCharged(); //pi- from Lambda-bar or p- from Lambda
      Mdst_charged Mdst_0   =(*i).child(0).mdstCharged(); //proton
      
      int pid_100=0;
      int pid_101=0;

      if ((*i).child(1).child(0).p().mag()>0.90 && (*i).child(1).child(1).p().mag()>0.10 && (*i).child(1).child(1).p().mag() <0.20 ){
	pid_100=4;
	pid_101=2;
      }else if ((*i).child(1).child(0).p().mag()>0.10 && (*i).child(1).child(0).p().mag()<0.20 && (*i).child(1).child(1).p().mag() <0.90 ){
	pid_100=2;
	pid_101=4;
      }
      ...
      Lambda0_init.setX((*i).child(1).mdstVee2().v(0));
      Lambda0_init.setY((*i).child(1).mdstVee2().v(1));
      Lambda0_init.setZ((*i).child(1).mdstVee2().v(2));
      ...
      if (MCstatus == 1){
	const Mdst_charged ch_100 =(*i).child(1).child(0).mdstCharged(); //pi+ from Lambda-bar or p+ from Lambda
	const Mdst_charged ch_101 =(*i).child(1).child(1).mdstCharged(); //p- from Lambda-bar or pi- from Lambda
	...
	b_tpl->column("hi0", Evtch_0.idhep());
	  ...
	  if (EvtP_100.mo(0))
	    {
	      //grandparent of pi+, should be psudoparticle
	...
	//B^{+} decay, Lambda-bar decay to pi+ (100) and p- (101)
        if(Evtch_100.idhep()== 211 && EvtP_100.idhep()== -3122 && EvtGP_100.idhep()== 689 && EvtGGP_100.idhep()== 521 
	   && Evtch_101.idhep()== -2212 && EvtP_101.idhep()== -3122 && EvtGP_101.idhep()== 689 && EvtGGP_101.idhep()== 521
	   && Evtch_0.idhep()== 2212 && EvtP_0.idhep()== 689 && EvtGP_0.idhep()== 521 ){
	  //list all possible situations for gamma ray id
	  if (mo2== 521 || gmo2==521 || ggmo2 == 521)
	    { hindex = 1;}
	  /*
	  if (
	      ((Evtch_2.idhep()== 22 ||std::abs(Evtch_2.idhep())== 11) && EvtP_2.idhep()== 521)
	      ||(Evtch_2.idhep()== 22  && std::abs(EvtP_2.idhep())== 11 && EvtGP_2==521)
	      ||(std::abs(Evtch_2.idhep())== 11  && EvtP_2.idhep()== 22 && EvtGP_2==521)
	      ){ hindex = 1;}
	  */
	}
	//B^{-} decay, Lambda decya to p-(101) and pi+ (100)
        else if(Evtch_100.idhep()== 2212 && EvtP_100.idhep()== 3122 && EvtGP_100.idhep()== -689 && EvtGGP_100.idhep()== -521
		&& Evtch_101.idhep()== -211 && EvtP_101.idhep()== 3122 && EvtGP_101.idhep()== -689 && EvtGGP_101.idhep()== -521
		&& Evtch_0.idhep()== -2212 && EvtP_0.idhep()== -689 && EvtGP_0.idhep()== -521 ){
	  if (mo2== -521 || gmo2== -521 || ggmo2== -521)
	    { hindex = 1;}
	  /*
...
//void ana_plambdag_1221::shape(Particle &b, float &R2, float &spher, float &cos_thr, float &cos_thp, float par_sfw[13], Vector4 &otherB_P)
void ana_plambdag_1221::shape(Particle &b, float &R2, float &spher, float &cos_thr, float &cos_thp, float par_sfw[13],Vector4 &otherB_P, HepPoint3D &bvertex, int & vertexflag, HepPoint3D & overtex)
{
...
void ana_plambdag_1221::GetImpactParameters(const Mdst_charged *charged, double *dr, double *dz, int t) 
     {
