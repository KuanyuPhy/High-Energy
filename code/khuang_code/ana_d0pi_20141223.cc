...
// Module class
class ana_d0pi_20141223 : public Module 
{
public:
  ana_d0pi_20141223(void){};
  ~ana_d0pi_20141223(void){};
  void init(int*);
  void term(void);
...
extern "C" Module_descr *mdcl_ana_d0pi_20141223()
{
  ana_d0pi_20141223 *module = new ana_d0pi_20141223;
  Module_descr *dscr = new Module_descr ( "ana_d0pi_20141223", module );
...
void 
ana_d0pi_20141223::hist_def(void)
{ 
...
void ana_d0pi_20141223::init(int*)
{
  evtcount=0;
...
void ana_d0pi_20141223::term (void)
{
/*
...
void ana_d0pi_20141223::begin_run(BelleEvent *evptr, int *status)
{
...
void 
ana_d0pi_20141223::event(BelleEvent *evptr, int *status)
{ 
...
//void ana_d0pi_20141223::shape(Particle &b, float &R2, float &spher, float &cos_thr, float &cos_thp, float par_sfw[13], Vector4 &otherB_P)
void ana_d0pi_20141223::shape(Particle &b, float &R2, float &spher, float &cos_thr, float &cos_thp, float par_sfw[13],Vector4 &otherB_P, HepPoint3D &bvertex, int & vertexflag, HepPoint3D & overtex)
{
...
void ana_d0pi_20141223::GetImpactParameters(const Mdst_charged *charged, double *dr, double *dz, int t) 
     {
