...
// Module class
class ana_psigmag_0308 : public Module 
{
public:
  ana_psigmag_0308(void){};
  ~ana_psigmag_0308(void){};
  void init(int*);
  void term(void);
...
extern "C" Module_descr *mdcl_ana_psigmag_0308()
{
  ana_psigmag_0308 *module = new ana_psigmag_0308;
  Module_descr *dscr = new Module_descr ( "ana_psigmag_0308", module );
...
void 
ana_psigmag_0308::hist_def(void)
{ 
...
//branch name length--> 8 characters(upper limit)
  ...
  pxGam1  pyGam1  pzGam1  epGam1 \
  m_pl chisqexk \
  hindex hi100 hi101 hi2 hi0 mo100 mo101 mo2 mo0 gmo100 gmo101 gmo0 gmo2 ggmo100 ggmo101  \
  charged nbnd nbpd bndnumber bvertexx bvertexy bvertexz overtexx overtexy overtexz \
...
void ana_psigmag_0308::init(int*)
{
  evtcount=0;
...
void ana_psigmag_0308::term (void)
{
/*
...
void ana_psigmag_0308::begin_run(BelleEvent *evptr, int *status)
{
...
void 
ana_psigmag_0308::event(BelleEvent *evptr, int *status)
{ 
...
//void ana_psigmag_0308::shape(Particle &b, float &R2, float &spher, float &cos_thr, float &cos_thp, float par_sfw[13], Vector4 &otherB_P)
void ana_psigmag_0308::shape(Particle &b, float &R2, float &spher, float &cos_thr, float &cos_thp, float par_sfw[13],Vector4 &otherB_P, HepPoint3D &bvertex, int & vertexflag, HepPoint3D & overtex)
{
...
void ana_psigmag_0308::GetImpactParameters(const Mdst_charged *charged, double *dr, double *dz, int t) 
     {
