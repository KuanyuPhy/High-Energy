...
int main(int argc, char *argv[])
{
	...
	//RooAddPdf mbc_pdf("mbc_pdf","Mb_c pdf", mbc,mbc_signal_fraction);//testtttt
        ...
        //Christal Ball
        //RooRealVar mbc_signal_mean("mbc_signal_mean", "mbc signal mean",5.28,5.27,5.29);
	...
	*/
	...
	//RooAddPdf mbc_pdf("mbc_pdf","Mb_c pdf", mbc_signal);//testtttt
        ...
        //////////////////////////////////
	RooRealVar mbc_a0("mbc_a0", "mbc_a0", -0.3, -1.0, 1.0);
	...
	//RooRealVar n("n","n",4.0,0.0,500);
    	//RooCBShape deltae("deltae_signal", "de signal",de, deltae_signal_mean,sigma_delta,alpha,n);	
	//RooProdPdf deltae_signal("deltae_signal","de signal", RooArgList(gaussx,deltae_signal1)) ;

        //RooRealVar ddeltae_signal_mean("deltae_signal_mean", "de signal mean",0.18, -0.2, 0.25);
        //RooRealVar dsigma_delta("sigma_delta","sigma_delta",0.04,0,3);//0.04,0,0.3
        //RooRealVar dalpha("alpha","alpha",0.6,0.0,5);
        //RooRealVar dn("n","n",4.0,0.0,500);
        //RooCBShape ddeltae("deltae_signal", "de signal",de, deltae_signal_mean,sigma_delta,alpha,n);
        //RooProdPdf deltae_pdf("de_signal_pdf", "de signal_pdf",RooArgList(ddeltae,deltae)); 

	//Three Gasussian
	//RooRealVar ga1_mean("ga1_mean", "ga1_mean", 0.1,-0.2,0.1);			
	//RooRealVar ga1_width("ga1_width", "ga1_width",0.0001,0.0,0.06); 

	//RooRealVar ga2_mean("ga2_mean", "ga2_mean", 0.5, -0.1, 0.1);			
	//RooRealVar ga2_width("ga2_width", "ga2_width",0.02, 0.0,0.05);  

	//RooRealVar ga3_mean("ga3_mean", "ga3_mean", 0.5, -0.2, 0.2);			
	//RooRealVar ga3_width("ga3_width", "ga3_width", 0.02, 0.0, 0.06);   

	//RooGaussian ga1("ga1", "ga1", de, ga1_mean, ga1_width); 
    	//RooGaussian ga2("ga2", "ga2", de, ga2_mean, ga2_width); 
    	//RooGaussian deltae("deltae_pdf", "deltae pdf", de, ga2_mean, ga2_width);
	//RooGaussian ga3("ga3", "ga3", de, ga3_mean, ga3_width); 
	//RooProdPdf deltae_pdf("de_signal_pdf", "de signal_pdf",RooArgList(ga3,deltae)); 
