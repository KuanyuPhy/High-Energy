...
int main(int argc, char *argv[])
{
	...
	// ----- 1-dim deltaE PDF -----
        RooRealVar mean("deltae_signal_mean", "de signal mean",-0.001593);
        RooRealVar sigma_delta1("sigma_delta1","sigma_delta1",0.01406);//0.04,0,0.3
        RooRealVar alpha1("alpha1","alpha1",1.467);
        RooRealVar n1("n1","n1",0.646);
        RooCBShape sig1("sig1", "Signal component 1",de,mean,sigma_delta1,alpha1,n1);
        RooRealVar mga1_mean("mga1_mean", "mga1_mean",-0.00199);
        RooRealVar mga1_width("mga1_width", "mga1_width",0.0761);
        RooGaussian sig2("sig2", "sig2",de, mga1_mean, mga1_width);
	RooRealVar sig1frac("sig1frac", "fraction of component 1 in signal",0.768);
        RooAddPdf deltae_signal("deltae_signal", "de signal_pdf", RooArgList(sig1,sig2), sig1frac);	
    
    // -------- bb de background ------------
    
        RooRealVar deltae_a0("deltae_a0", "deltae_a0",-0.7431);
        RooRealVar deltae_a1("deltae_a1", "deltae_a1", 0.186);
    ...
    // --------- qq de background ------------
	 	RooRealVar deltae_a2("deltae_a2", "deltae_a2",-0.5991);
        RooRealVar deltae_a3("deltae_a3", "deltae_a3", 0.151);
        //RooRealVar deltae_a2("deltae_a1", "deltae_a1", 0.1, -1.0, 1.0);
...
RooRealVar N_qq("N_qq", "N_qq",983,-1000.0, 20000.0);
 ...
 float toynumsig=a.PoissonD(1.75),toynumbb=b.PoissonD(12246),toynumqq=c.PoissonD(12240);// my expect value out put with poisson distribution
