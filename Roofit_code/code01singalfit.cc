...
int main(int argc, char *argv[])
{
	...
	// ----- 1-dim Mb_c PDF -----
	// Gaussian 紅色
	//RooRealVar mbc_signal_mean("mbc_signal_mean", "Mb_c signal mean", 5.28, 5.27, 5.29);			//5.28中間值 下限值 上限值    minuit演算法
	...
	*/
	...
	//////////////////////////////////
   	//Christal Ball
   	RooRealVar deltae_signal_mean("deltae_signal_mean", "de signal mean", 0.5, -0.2, 0.2);
