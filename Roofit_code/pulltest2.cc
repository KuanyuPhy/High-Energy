...
int main(int argc, char *argv[])
{
	...
	// ----- 1-dim deltaE PDF -----
        ...
        RooRealVar sigma_delta1("sigma_delta","sigma_delta",0.03185);//0.04,0,0.3
        RooRealVar alpha1("alpha","alpha",0.910);
        RooRealVar n1("n","n",134.843);
	...
	RooRealVar sig1frac("sig1frac", "fraction of component 1 in signal",0.9463);
        RooAddPdf deltae_signal("deltae_signal", "de signal_pdf", RooArgList(sig1,sig2), sig1frac);	
    
    // -------- bb de background ------------
    
        RooRealVar deltae_a0("deltae_a0", "deltae_a0", -0.7390);
        RooRealVar deltae_a1("deltae_a1", "deltae_a1", 0.122);
    ...
    // --------- qq de background ------------
	 	RooRealVar deltae_a2("deltae_a2", "deltae_a2",-0.4535);
        RooRealVar deltae_a3("deltae_a3", "deltae_a3", 0.123);
        //RooRealVar deltae_a2("deltae_a1", "deltae_a1", 0.1, -1.0, 1.0);
...
RooRealVar N_qq("N_qq", "N_qq",983,-1000.0, 20000.0);
 ...
 float toynumsig=a.PoissonD(1.12),toynumbb=b.PoissonD(2708),toynumqq=c.PoissonD(3770);// my expect value out put with poisson distribution
